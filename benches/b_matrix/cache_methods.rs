...
pub fn bench_small_matmul(c: &mut Criterion) {
    let mut group = c.benchmark_group("Small MatMulImplementation");
...
pub fn bench_medium_matmul(c: &mut Criterion) {
    let mut group = c.benchmark_group("Medium MatMulImplementation");
    let bsize = BLOCK * BLOCK;
...
pub fn bench_large_matmul(c: &mut Criterion) {
    let mut group = c.benchmark_group("Large MatMulImplementation");
    let bsize = BLOCK * BLOCK;
