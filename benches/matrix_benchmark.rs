...
use stellar::algebra::ndmethods::{par_tensor_mult, tensor_mult};
...
//     // Small matrix tests
//     c.bench_function("small_par_tensor_mult", |b| {
//         b.iter(|| par_tensor_mult(blocksize, black_box(&small_x), black_box(&small_y)))
//     });
...
//     // Medium matrix tests
//     c.bench_function("medium_par_tensor_mult", |b| {
//         b.iter(|| par_tensor_mult(blocksize, black_box(&medium_x), black_box(&medium_y)))
//     });
...
//     // Large matrix tests
//     c.bench_function("large_par_tensor_mult", |b| {
//         b.iter(|| par_tensor_mult(blocksize, black_box(&large_x), black_box(&large_y)))
//     });
